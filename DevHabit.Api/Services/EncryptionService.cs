...
public sealed class EncryptionService(IOptions<EncryptionOptions> options)
{
    ...
    public string Encrypt(string plainText) 
    {
        ...
        {
            throw new InvalidOperationException("Encryption failed", cryptographicException);
        }
    }
    ...
    public string Decrypt(string cipherText)
    {
        ...
        {
            throw new InvalidOperationException("Decryption failed", cryptographicException);
        }
    }
}
